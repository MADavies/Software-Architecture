...
namespace DavisonService.BazzasBazzar {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="BazzasBazzar.IStore")]
    public interface IStore {
        ...
        DavisonService.BazzasBazzar.Category[] GetAllCategories();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetAllCategories", ReplyAction="http://tempuri.org/IStore/GetAllCategoriesResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Category[]> GetAllCategoriesAsync();
        ...
        DavisonService.BazzasBazzar.Category GetCategoryById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetCategoryById", ReplyAction="http://tempuri.org/IStore/GetCategoryByIdResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Category> GetCategoryByIdAsync(int id);
        ...
        DavisonService.BazzasBazzar.Product[] GetFilteredProducts(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetFilteredProducts", ReplyAction="http://tempuri.org/IStore/GetFilteredProductsResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Product[]> GetFilteredProductsAsync(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice);
        ...
        DavisonService.BazzasBazzar.Product GetProductById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetProductById", ReplyAction="http://tempuri.org/IStore/GetProductByIdResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Product> GetProductByIdAsync(int id);
        ...
        DavisonService.BazzasBazzar.Order GetOrderById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetOrderById", ReplyAction="http://tempuri.org/IStore/GetOrderByIdResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Order> GetOrderByIdAsync(int id);
        ...
        DavisonService.BazzasBazzar.Order CreateOrder(string accountName, string cardNumber, int productId, int quantity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/CreateOrder", ReplyAction="http://tempuri.org/IStore/CreateOrderResponse")]
        System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Order> CreateOrderAsync(string accountName, string cardNumber, int productId, int quantity);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStoreChannel : DavisonService.BazzasBazzar.IStore, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StoreClient : System.ServiceModel.ClientBase<DavisonService.BazzasBazzar.IStore>, DavisonService.BazzasBazzar.IStore {
        ...
        public DavisonService.BazzasBazzar.Category[] GetAllCategories() {
            return base.Channel.GetAllCategories();
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Category[]> GetAllCategoriesAsync() {
            return base.Channel.GetAllCategoriesAsync();
        }
        
        public DavisonService.BazzasBazzar.Category GetCategoryById(int id) {
            return base.Channel.GetCategoryById(id);
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Category> GetCategoryByIdAsync(int id) {
            return base.Channel.GetCategoryByIdAsync(id);
        }
        
        public DavisonService.BazzasBazzar.Product[] GetFilteredProducts(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice) {
            return base.Channel.GetFilteredProducts(categoryId, categoryName, minPrice, maxPrice);
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Product[]> GetFilteredProductsAsync(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice) {
            return base.Channel.GetFilteredProductsAsync(categoryId, categoryName, minPrice, maxPrice);
        }
        
        public DavisonService.BazzasBazzar.Product GetProductById(int id) {
            return base.Channel.GetProductById(id);
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Product> GetProductByIdAsync(int id) {
            return base.Channel.GetProductByIdAsync(id);
        }
        
        public DavisonService.BazzasBazzar.Order GetOrderById(int id) {
            return base.Channel.GetOrderById(id);
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Order> GetOrderByIdAsync(int id) {
            return base.Channel.GetOrderByIdAsync(id);
        }
        
        public DavisonService.BazzasBazzar.Order CreateOrder(string accountName, string cardNumber, int productId, int quantity) {
            return base.Channel.CreateOrder(accountName, cardNumber, productId, quantity);
        }
        
        public System.Threading.Tasks.Task<DavisonService.BazzasBazzar.Order> CreateOrderAsync(string accountName, string cardNumber, int productId, int quantity) {
